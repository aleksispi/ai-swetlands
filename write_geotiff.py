...
# Code almost entirely copy-pasted from https://github.com/williamlidberg/Cultural-remains/blob/main/utils/WriteGeotiff.py
...
print("Running gdal.Open()")
gd = gdal.Open('../wetlands-data/matti/NNK_YTA.tif')
print("Reading tiff to numpy array")
big_tiff = np.array(tifffile.imread('big_tiff.tif')).astype(float)
output_path = 'tmp_tiff/first_test.tif'
print("Running the function")
write_gtiff(big_tiff, gd, output_path)
print("DONE")
